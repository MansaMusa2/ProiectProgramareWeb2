    ...
    <div class="container  ">
      ...
      <div class="row">
        ...
        <div class="video-container">
          <h4>Teppanyaki Tricks</h4>
          <iframe width="900" height="500" src="https://www.youtube.com/embed/mG1-jULNHoA" frameborder="0"></iframe>
        </div>
        <div class="video-container">
          <h4>Teppanyaki cuisine at a luxury 5-star hotel</h4>
          <br>
          <video width="900" height="500" controls>
            <source src="media/VideoLocal.mp4" type="video/mp4">
            Your browser does not support the video tag.
          </video>
        </div>
        <div class="audio-container">
          <h4>Restaurant with Background Music Sound Effect</h4>
          <audio controls autoplay loop preload="auto">
            <source src="media/AudioLocal.mp3" type="audio/mpeg">
